...
public class ColorPicker {
   ...
   public void show() {
      ...
      if (title != null) {
         ...
         titleView.setPadding(
                 ColorUtils.INSTANCE.dip2px(paddingTitleLeft, context), ColorUtils.INSTANCE.dip2px(paddingTitleTop, context),
                 ColorUtils.INSTANCE.dip2px(paddingTitleRight, context), ColorUtils.INSTANCE.dip2px(paddingTitleBottom, context));
      }
      ...
      if (marginColorButtonBottom != 0 || marginColorButtonLeft != 0 || marginColorButtonRight != 0 || marginColorButtonTop != 0) {
         colorViewAdapter.setColorButtonMargin(
                 ColorUtils.INSTANCE.dip2px(marginColorButtonLeft, context), ColorUtils.INSTANCE.dip2px(marginColorButtonTop, context),
                 ColorUtils.INSTANCE.dip2px(marginColorButtonRight, context), ColorUtils.INSTANCE.dip2px(marginColorButtonBottom, context));
      }
      if (colorButtonHeight != 0 || colorButtonWidth != 0) {
         colorViewAdapter.setColorButtonSize(ColorUtils.INSTANCE.dip2px(colorButtonWidth, context), ColorUtils.INSTANCE.dip2px(colorButtonHeight, context));
      }
      if (roundColorButton) {
   ...
   public ColorPicker addListenerButton(String text, final OnButtonListener listener) {
      ...
      params.setMargins(ColorUtils.INSTANCE.dip2px(10, context), 0, 0, 0);
